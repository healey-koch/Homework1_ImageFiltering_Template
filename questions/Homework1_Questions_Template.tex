...
Thankfully, there's a way to deal with the noises: image convolution. It's a type of image filtering, and is a fundamental image processing tool.
...
What kind of filter would you want to use to process your image of the Orion Nebula, and why? \textbf{[2 - 4 sentences]}
\end{tcolorbox}
\begin{tcolorbox}[colback=white!5!white,colframe=green!75!black]
\setbox0=\hbox{\parbox[t]{\textwidth}{
        %%%%%%% ANSWER STARTS HERE %%%%%%%%%%%%%%%%%%%%%%%%%%%%
