...
\begin{itemize}
  \item 5 questions \textbf{[13 + 11 + 12 + 7 + 7 = 50 + 3 bonus points]}.
...
\item \textbf{[5 points]} 
\begin{tcolorbox}[colback=orange!5!white,colframe=orange!75!black]
Why is image convolution important in Computer Vision? Which applications does it allow? What are some applications in which it could be misused? \textbf{[8-10 sentences]}
\end{tcolorbox}
