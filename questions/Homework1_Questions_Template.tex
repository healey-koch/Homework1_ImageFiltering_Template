...
\includegraphics[width=0.43\textwidth,height=6cm,keepaspectratio]
{images/orion-noise.png}



Thankfully, there's a way to deal with these artefacts (i.e., noises) as results of overexposure: image convolution. It's a type of image filtering, and is a fundamental image processing tool.
...
#    at 8MPix (calculated as height x width x channels)
